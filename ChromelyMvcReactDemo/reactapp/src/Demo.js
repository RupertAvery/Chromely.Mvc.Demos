...
import { get, post } from './services/chromely.service.js';
...
class Demo extends React.Component {
    ...
    boundObjectInfoCallback(jsonObj) {
        ...
        tempInfo.objective = jsonObj.Objective;
        tempInfo.platform = jsonObj.Platform;
        tempInfo.version = jsonObj.Version;
    ...
    boundObjectInfo() {
        get('/info', null, response => {
            this.boundObjectInfoCallback(response)
        });
    }
    ...
    boundObjectGet1Click(event) {
        ...
        get('/demo/getmovies', null, response => {
            this.boundObjectGet1Callback(response);
        });
    }
    ...
    boundObjectGet2Click(event) {
        ...
        get('/externalcontroller/movies', null, response => {
            this.boundObjectGet2Callback(response);
        });
    }
    ...
    boundObjectPostClick(event) {
        ...
        post('/demo/savemovies', null, moviesJson, response => {
            this.boundObjectPostCallback(response);
        });
    }
        ...
        return (
            <Container>
                <div className="centerBlock">
                    ...
                    <Row className="centerBlock">
                        <Button type="button" className="btn btn-light" onClick={this.toggleModal} style={{ margin: "#5px" }}>windows.cefQuery Demo</Button>
                ...
                <div>
                    <Modal className="modal-lg" isOpen={this.state.modal} toggle={this.toggleModal}>
                        <ModalHeader>.NET/JavaScript Integration (windows.cefQuery) Demo</ModalHeader>
                        <ModalBody>
                            <div>
                                <Nav pills>
                                    <NavItem>
                                ...
                                <TabContent activeTab={this.state.activeTab}>
                                    <TabPane tabId="get1">
                                        <div>
                                            <Row style={{ margin: "#5px" }}>
                                                &ensp;&ensp;&ensp;Route Path:&ensp;/demo/movies &ensp; (Restful Service in Local Assembly)&ensp;<button type="button" className="btn btn-primary btn-sm" onClick={this.boundObjectGet1Click}>Run</button>
                                            </Row>
                                            <br /><br />
                                            <Row>
                                                <Table>
                                    ...
                                    <TabPane tabId="post">
                                        <Row>
                                            &ensp;&ensp;&ensp;Route Path:&ensp;/demo/savemovies&ensp;(Restful Service in Local Assembly)&ensp;<button type="button" className="btn btn-primary btn-sm" onClick={this.boundObjectPostClick}>Run</button>
                                        </Row>
                                        <br /><br />
                                        <Row>
