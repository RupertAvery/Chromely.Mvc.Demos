  ...
  <div class="col-12">
    <div class="centerBlock">
      <div class="row">
        ...
        <div class="col">
             <img src="./assets/img/logo.png" class="img-rounded" alt="Vue Logo" width="200" height="200" style='margin-top: 20px;' />
        </div>
      </div>

      <span class="text-primary text-center"><h2>chromely + mvc + vue</h2></span>
